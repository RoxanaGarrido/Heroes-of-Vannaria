 ...
 * @author garri
 */
public class AsesinoOrden extends Asesino implements Orden {

    public AsesinoOrden(String nom, String categoria, int fuerza, int constitucion, int velocidad, int inteligencia, int suerte, Arma arma, String devocion) {
